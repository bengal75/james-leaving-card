    ...
    <div style={{ width: '100vw', height: '100vh', position: 'relative', overflow: 'hidden' }}>
      {webglError ? (
        <div style={{
          ...
          <div>
            <h1 style={{ fontSize: '24px', marginBottom: '16px' }}>WebGL Not Available</h1>
            <p style={{ fontSize: '16px', lineHeight: '1.5' }}>
              This 3D game requires WebGL support to run.<br/>
              Please try opening it in a modern browser with WebGL enabled,<br/>
              or check your browser's hardware acceleration settings.
            </p>
          </div>
        </div>
      ) : (
